<x-app-layout>
    <x-slot name="header">
        {{__("Tambah Portofolio Mahasiswa") }}
    </x-slot>

    <div class="lg:w-8/12">
        <form action="{{ route('add-portofolio') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <div class="mt-4 col-span-3">
                    ...
                    <div>
                        <select onchange="makeRefPoint()" id="jenis_kegiatan" disabled name="jenis_kegiatan"
                            class="w-full rounded-lg border-gray-300">
                ...
                <div class="mt-4">
                    ...
                    <div>
                        <input disabled type="text" id="ref_point" name="ref_point" value=""
                            class="w-full rounded-lg border-gray-300">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mt-4">
                    ...
                    <div>
                        <input type="text" class="rounded-lg w-full border-gray-300" id="penyelenggara"
                            value="{{old('penyelenggara')}}" name="penyelenggara">
                        @error('penyelenggara')
                        <p class="text-red-500 text-sm mt-2">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <div>
                        <input type="file" class="w-full border-gray-300" id="bukti" name="bukti">
                        @error('bukti')
                        <p class="text-red-500 text-sm mt-2">{{$message}}</p>
                        @enderror
                    </div>
